 ...
 * Modified content
 *
 * Modified, if products are added, when increase the number of items and the subtotal.
 *
 * @package		CodeIgniter
 * @subpackage	Libraries
 * @category	Shopping Cart
 * @author		Veres József
 * @link		http://codeigniter.hu/scripts
 * @since		Modified version 1.1 (2012.06.10), usable to Codeigniter 2.1.0
 *
 */
