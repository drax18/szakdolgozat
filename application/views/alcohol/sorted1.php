<div id="newdrinklist">
           ...
           <div id="table">
                   <table height="120">
                       <tr>
                            <td><h4 style="text-decoration:underline;"><a style="color:black;" href="<?php echo site_url("alcohol/drink/$row->link_name"); ?>"><?php echo character_limiter($row->name, 6); ?></a></h4></td>
                       </tr>
                       <tr>
